...
{
    [SerializeField] private ObjectEventReference _transform;
    ...
    {
        _transform.RegisterListenerExtended(OnCameraCreated,OnCameraDestroyed,OnCameraEnabled,OnCameraDisabled);
    }

    private void OnDisable()
    {
        _transform.UnregisterListenerExtended(OnCameraCreated,OnCameraDestroyed,OnCameraEnabled,OnCameraDisabled);
    }
